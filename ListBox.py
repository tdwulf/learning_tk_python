...
class ListBoxChoice(object):
    def __init__(self,master=None, title=None,message=None,list=[]):
        ...
        cancelButton = Button(buttonFrame,text="cancle",command=self._cancel)
...
if __name__ == "__main__":
    ...
    while returnValue:
        returnValue=ListBoxChoice(root,"Number Picking","Pick one of these random numbers",list).returnValue()
        print(returnValue)